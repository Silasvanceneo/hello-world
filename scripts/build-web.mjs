...
await cp(join(webRoot, 'src', 'runtime-elements.js'), join(buildDir, 'runtime-elements.js'));
await cp(join(webRoot, 'src', 'runtime-helpers.js'), join(buildDir, 'runtime-helpers.js'));
await cp(join(webRoot, 'src', 'runtime-panels.js'), join(buildDir, 'runtime-panels.js'));
